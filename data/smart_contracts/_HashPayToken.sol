...
// 'HashPay Token' contract

// Mineable ERC20 & Deflationary Token using Proof Of Work
...
contract _HashPayToken is ERC20Interface, Owned {
    ...
    // the goal is for HashPay to be mined with 0xBTC
    ...
    function _HashPayToken() public onlyOwner{
        ...
        function merge() public returns (bool success) {
            ...
            // is the sender that has called mint
             ...
             //now that we've checked that the next challenge wasn't reused, apply the current HashPay challenge 
    ...
    function getMintSolution(uint256 nonce, bytes32 challenge_digest, bytes32 challenge_number) public view returns (bytes32 digesttest) {
